...
while True:
    ...
    gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY) #clor to grey
    ...
    for rect in rects:
        ...
        cv2.drawContours(frame, [leftEyeHull], -1, (0, 0, 255, 255), 1)
        cv2.drawContours(frame, [rightEyeHull], -1, (0, 0, 255, 255), 1)
